...
export interface LicenseTokenPayload {
  ...
  // Mandantenfähigkeit (Nutzervorgabe, 2026-08-27, erweitert 2026-08-28 um
  // Feature-Ebene): die aktuell für diesen Mandanten gebuchten und
  // aktivierten Module (siehe `MandantModule`/`module-catalog.ts`) inkl.
  // ihrer aktiven Unter-Features (bei Datenschutz: welche der 7 Reiter) –
  // Teil des signierten Tokens, damit eine Client-Installation ihren
  // Modul-Entitlements genauso vertrauen kann wie dem Lizenzstatus selbst.
  modules: { key: string; features: string[] }[];
}
