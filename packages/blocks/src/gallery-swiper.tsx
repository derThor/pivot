...
export function GallerySwiper({
  ...
  return (
    <div className={cn("gallery-swiper-wrapper w-full", className)}>
      ...
      {/* Plain <style> statt Next.js' `<style jsx global>` – dieses Paket
          wird von mehreren Next.js-Apps konsumiert (apps/web, künftig
          apps/site), soll aber nicht auf Next-spezifische Compiler-
          Transforms angewiesen sein. */}
      <style
